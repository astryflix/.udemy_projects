...
if playing == 'y':
    while True:
        ...
        user_score = user_card + user_card2
        computer_score = computer_card2 + computer_card
        print(f"Your cards:", user_card, "and", user_card2, "current score:", user_score)
        ...
        if computer_score == 21:
            print("Computer win")
        further_playing = input("Type 'y' to get another card, type 'n' to pass: ").lower()
        if further_playing == "y":
            user_card3 = random.choice(cards)
            computer_card3 = random.choice(cards)
            user_score = user_card + user_card2 + user_card3
            computer_score = computer_card2 + computer_card + computer_card3
            if user_score or computer_score > 21:
                cards[0] = 0
                user_score = user_card + user_card2 + user_card3
                computer_score = computer_card2 + computer_card + computer_card3
